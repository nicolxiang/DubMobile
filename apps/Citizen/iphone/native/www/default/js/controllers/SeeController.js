...
citizenApp.controller('SeeController', function($scope, $http, $rootScope, $location, eventService,articleService) {
	...
	$scope.articles.push({
		...
		text:"Six of Dubai's Feel-good Healthy Desserts"
	});
	...
	$scope.articles.push({
		...
		text:"Go Organic! UAE farmers delivering organic produce direct to your door"
	});
	...
	$scope.articles.push({
		...
		text:"Love Tom and Serg? Look At What They Have in Store Next..."
	});
